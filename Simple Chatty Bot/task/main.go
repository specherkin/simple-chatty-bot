...
func askQuestionAndCheckAnswer(question string, numOfRightAnswer int, answers ...string) bool {
	...
	var choice int
	fmt.Scan(&choice)
	return choice == numOfRightAnswer
}

func startQuiz() {
	fmt.Println("Let's test your programming knowledge.")
	// write your code here
	for !askQuestionAndCheckAnswer("Why do we use methods?", 2,
